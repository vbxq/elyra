        ...
        match opcode_byte {
            ...
            127 => {
                ...
                match inner {
                    ...
                    31 => {
                        ...
                        let character = self.heap.get(string_ref).and_then(|object| {
                        ...
                        if let Some(character) = character {
                            ...
                            reg_set!(
                                first + 1,
                                int_value!(i64::try_from(byte_offset + character.len())
                                    .unwrap_or(i64::MAX))
                            );
                            ip = (ip as isize + offset as isize) as usize;
                        }
                    ...
                    32 => {
                        ...
                        if let Ok(index) = usize::try_from(index)
                            && let Some(object) = self.heap.get(vector_ref)
                    ...
                    33 => {
                        ...
                        if let Ok(index) = usize::try_from(index)
                            && let Some(object) = self.heap.get(array_ref)
            ...
            29..=30 | 40..=41 => {
                ...
                let should_continue = if step > 0 {
                    if inclusive { new_iter <= end } else { new_iter < end }
                } else {
                    if inclusive { new_iter >= end } else { new_iter > end }
                };
                if should_continue {
