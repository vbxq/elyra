...
static MODULE_NAME: &[u8] = b"cycle_b\0";
static MODULE_VERSION: &[u8] = b"0.1.0\0";
static EXPORT_NAME: &[u8] = b"b\0";

static DEP_NAME: &[u8] = b"cycle_a\0";

extern "C" fn cycle_b_fn(
    _vm: *mut c_void,
    ...
    unsafe {
        *out = value_int(2).expect("fixture integer fits");
    }
    0
}
...
static EXPORTS: [AelysExport; 1] = [AelysExport {
    ...
    arity: 0,
    _padding: [0; 2],
    value: cycle_b_fn as *const c_void,
